...
class Link:
    ...
    def poll_and_notify(self):
        ...
        if (len(self.samples) == Link.SAMPLES and
                util.average(self.samples) < Link.THRESHOLD):
    ...
    def up(self):
        ...
        success = (subprocess.call(shlex.split(cmd)) == 0)
    ...
    def is_ready(self):
        return (getattr(self, '_ready', False) or
                (self.state == 'up' and self.ipaddr != None))
